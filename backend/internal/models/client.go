...
type Client struct {
	...
	BillingoUnit          string    `json:"billingo_unit" gorm:"column:billingo_unit;size:50"`
	BillingoUnitPriceType string    `json:"billingo_unit_price_type" gorm:"column:billingo_unit_price_type;size:10"`
...
type ClientCreateRequest struct {
	...
	BillingoUnit          string `json:"billingo_unit"`
	BillingoUnitPriceType string `json:"billingo_unit_price_type"`
}
